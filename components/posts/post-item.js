    ...
    <Link href={linkPath}>
      <div className={classes.container}>
        ...
        <div className={classes.content}>
          <span className={classes.span}>Olivia Rhye • <time>{formattedDate}</time></span>
          <h3>{title}</h3>
          <p>{excerpt}</p>
